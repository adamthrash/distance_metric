...
ggsave("../manuscript/imgs/correlation.png", width = 8.5, height = 5.5, dpi = 300)
```
...
ggsave("../manuscript/imgs/N50_complete.png", width = 8.5, height = 5.5, dpi = 300)
```
...
ggsave("../manuscript/imgs/contiguity_correlation.png", width = 8.5, height = 5.5, dpi = 300)
...
ggsave("../manuscript/imgs/busco_correlation.png", width = 8.5, height = 5.5, dpi = 300)
```
...
correlation_matrix = rcorr(as.matrix(merged %>% select(-Species)), type="spearman")
correlation_matrix = flatten_correlation_matrix(correlation_matrix$r,
                                                correlation_matrix$P)
correlation_matrix =  correlation_matrix %>% 
    mutate(cor = ifelse(p >= 0.05,
                        NA,
                        .data$cor))
ggplot(data = correlation_matrix, 
       aes(column, row, fill = cor))+
    geom_tile(color = "white") +
    theme_minimal() + 
    scale_fill_gradient2(low = muted("red"),
